...
class MonodepthModel(object):
    ...
    def build_losses(self):
        with tf.variable_scope('losses', reuse=self.reuse_variables):
            ...
            # SEGMENTATION LOSS
            self.seg_loss = jaccard_coef_loss(self.mask, self.pred)
            
            # TOTAL LOSS
            self.total_loss = 1*(self.image_loss + self.params.disp_gradient_loss_weight * self.disp_gradient_loss + 0*self.params.lr_loss_weight * self.lr_loss) + 1*self.seg_loss
