...
#             print(true_positives.tolist())
#             print(annotations.shape[0])
#             modified_recall = np.sum(true_positives) / float(annotations.shape[0])
#             print(modified_recall)
    ...
    return modified_recall, modified_precision, average_precisions
