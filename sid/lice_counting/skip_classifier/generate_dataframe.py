...
from research_api.skip_classifier import add_train_dataset
...
# Get the subset of data to build the skip classifier
...
out_file = '/root/data/skip-classifier/datasets/%s.csv' % (today, )

skip_dataset.to_csv(out_file)
...
add_train_dataset(today, out_file, metadata)