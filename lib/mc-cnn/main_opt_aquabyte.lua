function get_opt()
	...
	cmd:option('-depth_map_out_bin_path_1', '')
	cmd:option('-depth_map_out_bin_path_2', '')
	cmd:option('-depth_map_out_png_path', '')
	cmd:option('-frame_path_left', '')
	cmd:option('-frame_path_right', '')

	cmd:option('-num_to_skip', 0)
	cmd:option('-num_to_process', 0)
