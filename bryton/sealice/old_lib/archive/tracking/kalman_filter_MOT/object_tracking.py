...
from sealice_candidates import SealiceCandidates
...
def main():
    ...
    #cap = cv2.VideoCapture('data/Videos/TrackingBugs.mp4')
    cap = cv2.VideoCapture('testfile_piece_00.mp4')

    # Create Object Detector
    detector = SealiceCandidates()
    #detector = Detectors()

    # Create Object Tracker
    #tracker = Tracker(160, 30, 5, 10)
    tracker = Tracker(50, 100, 50, 200)
